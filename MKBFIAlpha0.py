'''
Welcome to MKBFIAlpha0, short for Merged Kostas Beer Fermentation Isothermal: Alpha Edition, Version 0
...
- Note: Line 403: "RuntimeWarning: invalid value encountered in divide", because did not use np.divide for now

For MKBFIAlpha1:
- The One-At-a-Time Response Curves will be added back
'''
